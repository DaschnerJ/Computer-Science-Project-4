...
public class ExampleLinkedList<E> extends AbstractSequentialList<E>
	...
	private class ListItr implements ListIterator<E> {
		...
		public void remove() {
			...
			try {
				ExampleLinkedList.this.remove(lastReturned);
	...
	@SuppressWarnings("unchecked")
	public Object clone() {
		ExampleLinkedList<E> clone = null;
		try {
			clone = (ExampleLinkedList<E>) super.clone();
